 ...
 * on 2014-06-11 at 22:45:05 UTC 
 * Modify at your own risk.
 */

package softhealth.zombiecatch.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetUser extends UserendpointRequest<softhealth.zombiecatch.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.Long id) {
      super(Userendpoint.this, "GET", REST_PATH, null, softhealth.zombiecatch.userendpoint.model.User.class);
   ...
   *
   * @param content the {@link softhealth.zombiecatch.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(softhealth.zombiecatch.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<softhealth.zombiecatch.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(softhealth.zombiecatch.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, softhealth.zombiecatch.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<softhealth.zombiecatch.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, softhealth.zombiecatch.userendpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(softhealth.zombiecatch.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<softhealth.zombiecatch.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(softhealth.zombiecatch.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, softhealth.zombiecatch.userendpoint.model.User.class);
    }
