 ...
 * on 2014-06-11 at 22:25:38 UTC 
 * Modify at your own risk.
 */

package softhealth.zombiecatch.gameendpoint;
...
public class Gameendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.16.0-rc of the gameendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class GetGame extends GameendpointRequest<softhealth.zombiecatch.gameendpoint.model.Game> {
    ...
    protected GetGame(java.lang.Long id) {
      super(Gameendpoint.this, "GET", REST_PATH, null, softhealth.zombiecatch.gameendpoint.model.Game.class);
   ...
   *
   * @param content the {@link softhealth.zombiecatch.gameendpoint.model.Game}
   * @return the request
   */
  public InsertGame insertGame(softhealth.zombiecatch.gameendpoint.model.Game content) throws java.io.IOException {
    InsertGame result = new InsertGame(content);
    initialize(result);
    return result;
  }

  public class InsertGame extends GameendpointRequest<softhealth.zombiecatch.gameendpoint.model.Game> {
     ...
     * @since 1.13
     */
    protected InsertGame(softhealth.zombiecatch.gameendpoint.model.Game content) {
      super(Gameendpoint.this, "POST", REST_PATH, content, softhealth.zombiecatch.gameendpoint.model.Game.class);
    }
  ...
  public class ListGame extends GameendpointRequest<softhealth.zombiecatch.gameendpoint.model.CollectionResponseGame> {
     ...
     */
    protected ListGame() {
      super(Gameendpoint.this, "GET", REST_PATH, null, softhealth.zombiecatch.gameendpoint.model.CollectionResponseGame.class);
    }
   ...
   * @return the request
   */
  public RemoveGame removeGame(java.lang.Long id) throws java.io.IOException {
    RemoveGame result = new RemoveGame(id);
    initialize(result);
    return result;
  }

  public class RemoveGame extends GameendpointRequest<Void> {
     ...
     * @since 1.13
     */
    protected RemoveGame(java.lang.Long id) {
      super(Gameendpoint.this, "DELETE", REST_PATH, null, Void.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
    ...
    public RemoveGame setId(java.lang.Long id) {
      this.id = id;
      return this;
    }
   ...
   * @return the request
   */
  public UpdateGame updateGame(softhealth.zombiecatch.gameendpoint.model.Game content) throws java.io.IOException {
    UpdateGame result = new UpdateGame(content);
    initialize(result);
    return result;
  }

  public class UpdateGame extends GameendpointRequest<softhealth.zombiecatch.gameendpoint.model.Game> {
     ...
     * @since 1.13
     */
    protected UpdateGame(softhealth.zombiecatch.gameendpoint.model.Game content) {
      super(Gameendpoint.this, "PUT", REST_PATH, content, softhealth.zombiecatch.gameendpoint.model.Game.class);
    }
